...
Since few samples seems to be very poor in sequences, we should remove them as they can introduce some biases during the biodiversity analysis. We have to set a threshold (often, arbitrarily).
